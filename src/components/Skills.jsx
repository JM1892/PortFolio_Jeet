  ...
  return (
    <div>
      <div className='bg-gradient-to-br from-green-500 to-cyan-500 py-2 h-auto mx-4 rounded-xl my-4'>
            ...
            <div className='backdrop-blur-sm shadow-xl bg-white/50 text-center rounded-xl my-2'>
                        <div className='py-2'>
        ...
        <div className='grid place-items-center h-auto mx-5'>
            ...
            <div>
                <div className='flex-grow md:justify-between md:items-center md:mx-2'>
                    <div className='text-center inline-flex m-5 backdrop-blur-sm bg-white/50 p-5 rounded-xl shadow-xl border-b-2 border-orange-500 hover:bg-orange-300 hover:shadow-orange-500'><img className='w-10 mx-3' src={html} alt="" /></div>
                    <div className='text-center inline-flex m-5 backdrop-blur-sm bg-white/50 p-5 rounded-xl shadow-xl border-b-2 border-blue-500 hover:bg-blue-300 hover:shadow-blue-500'><img className='w-10 mx-3' src={css} alt="" /></div>
                    <div className='text-center inline-flex m-5 backdrop-blur-sm bg-white/50 p-5 rounded-xl shadow-xl border-b-2 border-yellow-500 hover:bg-yellow-200 hover:shadow-yellow-500'><img className='w-10 mx-3' src={js} alt="" /></div>
                    <div className='text-center inline-flex m-5 backdrop-blur-sm bg-white/50 p-5 rounded-xl shadow-xl border-b-2 border-sky-500 hover:bg-sky-300 hover:shadow-sky-500'><img className='w-10 mx-3' src={react} alt="" /></div>
                    <div className='text-center inline-flex m-5 backdrop-blur-sm bg-white/50 p-5 rounded-xl shadow-xl border-b-2 border-sky-500 hover:bg-sky-300 hover:shadow-sky-500'><img className='w-10 mx-3' src={tailwind} alt="" /></div>
                    <div className='text-center inline-flex m-5 backdrop-blur-sm bg-white/50 p-5 rounded-xl shadow-xl border-b-2 border-violet-500 hover:bg-violet-300 hover:shadow-violet-500'><img className='w-10 mx-3' src={boot} alt="" /></div>
                    <div className='text-center inline-flex m-5 backdrop-blur-sm bg-white/50 p-5 rounded-xl shadow-xl border-b-2 border-violet-500 hover:bg-violet-300 hover:shadow-violet-500'><img className='w-10 mx-3' src={git} alt="" /></div>
                </div>
                <div className='grid place-item-center h-auto px-2 py-1 my-2 text-center'>
                    ...
                    <div className='backdrop-blur-sm shadow-xl bg-white/50 rounded-xl my-3'>
                        <div>
